...
exports.auth = (scb) => {
  ...
  const loadAuthUrl = () => {
    authWindow.loadURL('https://stackexchange.com/oauth/dialog?redirect_uri=https://stackexchange.com/oauth/login_success&client_id=7276&scope=write_access private_info');
  };
